// BFF 프록시: GET /api/observability/metrics/infra
// dashboard → observability-service /v1/metrics/infra
...
export async function GET(request: Request) {
  ...
  const upstream = `${BASE_URL}/v1/metrics/infra?${searchParams.toString()}`
